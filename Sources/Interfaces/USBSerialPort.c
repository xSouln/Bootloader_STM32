...
#include "usbd_conf.h"
//=================================================================================================================================
#define USBX_RX_CIRCLE_BUF_SIZE CDC_DATA_HS_OUT_PACKET_SIZE
#define USBX_RX_OBJECT_BUF_SIZE 0x1ff
#define USBX_TX_CIRCLE_BUF_SIZE 0x3ff
...
static int8_t USBSerialPortReceive(uint8_t* buf, uint32_t *len){
  ...
  HAL_PCD_EP_Receive(hUsbDeviceFS.pData, CDC_OUT_EP, USBX_RX_CIRCLE_BUF, USBX_RX_CIRCLE_BUF_SIZE);
  return ACCEPT;
}
//=================================================================================================================================
